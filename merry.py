...
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m
	    ...
	    Welcome To Bot Protect  By ŚhÀH•ŹÀ!η
...
wait = {
    ...
    'autoJoin':True,
    'autoAdd':True,
    'autoCancel':{"on":True, "members":300},
    'autoLeave':False,
    'autoLeave1':False,
    "detectMention":False,
    "Mentionkick":False,
...
def changeProfileVideo(to):
    if settings['changeProfileVideo']['picture'] == None:
        return cl.sendMessage(to, "pHOTO tidak ditemukan")
...
def help():
    ...
    key = key.title()
    helpMessage = "╭━━━━━━━━━━━━━━━\n"
    helpMessage += "│┃ " + "╭──⍟🔰 􏿿􀰂􀰂✍͡➴͜ოυȿἶβąƮ`š ѕqυα∂➣➻•⍟─\n"
    helpMessage += "│┃" + " ├───༼ᴍᴇɴᴜ For 􏿿􀰂􀰂✍͡➴͜ოυȿἶβąƮ➣➻────────────────\n"
    helpMessage += "│┃" + " ├──────────────\n"
    ...
    num = (num+1)
    helpMessage += "│🔰 %i. " % num + key + "ᴜᴘʙᴏᴛ 「ubah pHOTO」\n"
    num = (num+1)
    helpMessage += "│🔰 %i. " % num + key + "1/10ᴜᴘ 「ubah pHOTO」\n"
    num = (num+1)
    ...
    helpMessage += "│┃ " + "╰──⍟ 🔰 􏿿􀰂􀰂✍͡➴͜ოυȿἶβąƮ`š ѕqυα∂➣➻• ⍟─────────\n"
    helpMessage += "╰━━━━━━━━━━━━━━━━"
    helpMessage += " Creator: https://line.me/ti/p/~shahzain786 \n"
    return helpMessage
...
def helpbot():
    ...
    key = key.title()
    helpMessage2 = "╭━━━━━━━━━━━━━━━━\n"
    helpMessage2 += "│┃ " + "╭───⍟🔰 􏿿􀰂􀰂✍͡➴͜ოυȿἶβąƮ`š ѕqυα∂➣➻•⍟─\n"
    ...
    helpMessage2 += "│┃ " + "╰──⍟ 🔰 􏿿􀰂􀰂✍͡➴͜ოυȿἶβąƮ`š ѕqυα∂➣➻• ⍟────────\n"
    helpMessage2 += "╰━━━━━━━━━━━━━━━━"
    helpMessage2 += " My ID LINE : 〘 https://line.me/ti/p/~shahzain786 〙\n"
    return helpMessage2
                ...
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    ...
                    for x in groups.members:
                        if korban in x.displayName:
                            cl.sendMessage(msg.to, korban + " already Berada DiGrup Ini")
                        else:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                cl.createGroup("ye 1st hai baki 9999",[target])
                                cl.createGroup("🎀🆂🆄🅳🅷🅰🆁 🅹🅰🅾🎀",[target])
                                cl.createGroup("🎀🆂🆄🅳🅷🅰🆁 🅹🅰🅾🎀",[target])
                                cl.createGroup("🎀🆂🆄🅳🅷🅰🆁 🅹🅰🅾🎀",[target])
                                cl.createGroup("🎀🆂🆄🅳🅷🅰🆁 🅹🅰🅾🎀",[target])
                                cl.createGroup("🎀🆂🆄🅳🅷🅰🆁 🅹🅰🅾🎀",[target])
               ...
               if msg.contentType == 1:
                  if msg._from in mid:
                     if settings["Addimage"]["status"] == True:
                         ...
                         cl.sendMessage(msg.to, "succeeded Add gambar {}".format(str(settings["Addimage"]["name"])))
                        ...
                        if cmd == "on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              k1.sendMessage(msg.to,"Succes Bersihkan {} Daftar Blacklist".format(str(len(bl["blacklist"]))))
                              k2.sendMessage(msg.to,"Succes Bersihkan {} Daftar Blacklist".format(str(len(bl["blacklist"]))))
                              k3.sendMessage(msg.to,"Succes Bersihkan {} Daftar Blacklist".format(str(len(bl["blacklist"]))))
                              k4.sendMessage(msg.to,"Succes Bersihkan {} Daftar Blacklist".format(str(len(bl["blacklist"]))))
                              k5.sendMessage(msg.to,"Succes Bersihkan {} Daftar Blacklist".format(str(len(bl["blacklist"]))))
                              k6.sendMessage(msg.to,"Succes Bersihkan {} Daftar Blacklist".format(str(len(bl["blacklist"]))))
                              k7.sendMessage(msg.to,"Succes Bersihkan {} Daftar Blacklist".format(str(len(bl["blacklist"]))))
                              k8.sendMessage(msg.to,"Succes Bersihkan {} Daftar Blacklist".format(str(len(bl["blacklist"]))))
                              k9.sendMessage(msg.to,"Succes Bersihkan {} Daftar Blacklist".format(str(len(bl["blacklist"]))))
                              k9.sendMessage(msg.to,"Succes Bersihkan {} Daftar Blacklist".format(str(len(bl["blacklist"]))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                               try:
                                   ...
                                   cl.sendMessage(msg.to,"Chat already d bersihkan 👍")
                               except:
                                   pass
                          ...
                          if msg._from in owner or msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated = []
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "🔰 􏿿􀰂􀰂✍͡➴͜ოυȿἶβąƮ`š ѕqυα∂➣➻• ɪɴғᴏ\n"
                           ...
                           if wait["selfbot"] == True:
                            ...
                            if msg._from in admin or msg._from in owner:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        cl.sendMessage(i, " Please invite Oner kami")
                                        cl.leaveGroup(i)
...
#====================================================================
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendMessage(msg.to, "Lurking succeeded dinoaktifkan\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
...
#==============add video==========================================================================
                          ...
                          if msg._from in admin:
                            ...
                            if name in images:
                                ...
                                cl.sendMessage(msg.to, "pHOTO itu tidak ada dalam list")
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in welcome:
                                       msgs = "Welcome Msg already aktif"
                                  else:
                                  ...
                                  cl.sendMessage(msg.to, "「activated」\n" + msgs)
                                    ...
                                    if msg.to in welcome:
                                         ...
                                         msgs = "Welcome Msg already tidak aktif"
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectqr:
                                       msgs = "Protect url already aktif"
                                  else:
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Url 」\n" + msgs)
                                    ...
                                    if msg.to in protectqr:
                                         ...
                                         msgs = "Protect url already tidak aktif"
                                    cl.sendMessage(msg.to, "「 Status Protect Url 」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectkick:
                                       msgs = "Protect kick already aktif"
                                  else:
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect kick 」\n" + msgs)
                                    ...
                                    if msg.to in protectkick:
                                         ...
                                         msgs = "Protect kick already tidak aktif"
                                    cl.sendMessage(msg.to, "「 Status Protect kick 」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectjoin:
                                       msgs = "Protect join already aktif"
                                  else:
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Join 」\n" + msgs)
                                    ...
                                    if msg.to in protectjoin:
                                         ...
                                         msgs = "Protect join already tidak aktif"
                                    cl.sendMessage(msg.to, "「 Status Protect Join 」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectcancel:
                                       msgs = "Protect cancel already aktif"
                                  else:
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Cancel 」\n" + msgs)
                                    ...
                                    if msg.to in protectcancel:
                                         ...
                                         msgs = "Protect cancel already tidak aktif"
                                    cl.sendMessage(msg.to, "「 Status Protect Cancel 」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectinvite:
                                       msgs = "Protect invite already aktif"
                                  else:
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Invite 」\n" + msgs)
                                    ...
                                    if msg.to in protectinvite:
                                         ...
                                         msgs = "Protect invite already tidak aktif"
                                    cl.sendMessage(msg.to, "「 Status Protect Invite 」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectantijs:
                                       msgs = "Protect Antikicker already aktif"
                                  else:
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Anti Kicker 」\n" + msgs)
                                    ...
                                    if msg.to in protectantijs:
                                         ...
                                         msgs = "Protect Anti Kicker already tidak aktif"
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Hantu  」\n" + msgs)
                                    ...
                                    if msg.to in ghost:
                                         ...
                                         msgs = "Hantu already tidak aktif"
                                    cl.sendMessage(msg.to, "「 Status Hantu 」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  ...
                                  if msg.to in protectcancel:
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "Status : [ ✔ ]\nDi Group : " +str(ginfo.name)
                                      msgs += "\nAll protecttion already activated"
                                  else:
                                      protectcancel.append(msg.to)
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "Status : [ ✔ ]\nDi Group : " +str(ginfo.name)
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protection 」\n" + msgs)
                                    ...
                                    if msg.to in protectcancel:
                                         ...
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Status : [ ❌ ]\nDi Group : " +str(ginfo.name)
                                         msgs += "\nAll protection already turnd off"
                                    else:
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Status : [ ❌ ]\nDi Group : " +str(ginfo.name)
                          ...
                          if wait["selfbot"] == True:
                            if sender in admin:
                              ...
                              with open('bl.json', 'w') as fp:
                               ...
                               cl.sendMessage(msg.to, " My Owner: line.me/ti/p/~shahzain786")
#===========COMMAND SET============#
