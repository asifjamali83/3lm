...
"""%(Bot_startTime))
#==============================================================
cl = LINE("EIzcnZQm4qTGSNXhJBR5.isSbBBaRrPUDuTKiIvaBvq.NHUsj0JtG3xQyt3lIwCU4WroQ3SvXRbSwKBGUmbAh5I=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Selfbot Login ]\033[0m"""%(Bot_startTime))

k1 = LINE("EILJ4WRcuXP8Tp8ZCoC8.omcPlG0YkFDpR5/IGCAaIa.fSZYq+kK066fDwYVGns2uMbh2FjJXY6gCS+5IWD8vv8=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist1 Login ]\033[0m"""%(Bot_startTime))

k2 = LINE("EIEsCDLAfEUjubqLDaM1.LVJmcFk2koNI5LVdgrD+iq.pLwGORCdbD51ihUyBt2P+2KuqO0jn9szehE6giIqsY8=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist2 Login ]\033[0m"""%(Bot_startTime))

k3 = LINE("EI6FRzILpmNxP1XSKgId.GXdG+f6NVnzQ118ZQMtz+q.K4dqR0CpRjP8NAxHbyTUk8o6iigD0u7Ftt40cd0AY/Q=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist3 Login ]\033[0m"""%(Bot_startTime))

k4 = LINE("EImDDYws73j1b7XtMc43.9rcnIlmX7056Edee+gbcuW.4eJM4fy9kzUh/aj4lNfb0NPMJKDzvq3e5FXl8Xv1+Kc=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist4 Login ]\033[0m"""%(Bot_startTime))

k5 = LINE("EIkOaJ0jFTeysgiU3b12.W7oCwSIab9BPAh0qWx1gKG.xg1esdF4EcbErX/rg6ogcqqZvi39CP5FB6Tg8yIa/e8=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist5 Login ]\033[0m"""%(Bot_startTime))

k6 = LINE("EIxtUniUo2dnjJGqtxx3.k2ZIllMnJDksTXIShFZHeW.CsoEebRuqg3i6saFJcCb/sy+a6K9FdJDFywDIzRRveg=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist6 Login ]\033[0m"""%(Bot_startTime))

k7 = LINE("EIVv32vzkxEwmb1aoCg8.CB6L7j9xOG5rOYWFL/8+ka.wyvnOhELeVOyHILGohEs7C0lnomBCTXjcMpO0hfh7fc=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist7 Login ]\033[0m"""%(Bot_startTime))

k8 = LINE("EIFIPcxKMNM2vw35Bf48.GYjXJb0vVwcxxU6GoVUHga.bV71WkZfTZ8y8KHmoPwInY10fgo9n03yH10z16IuyPI=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist8 Login ]\033[0m"""%(Bot_startTime))

k9 = LINE("EIF9COqUOcj8YNrsYNU2.i3qs82aNYiEVs1VoBC+2CG.9YJVefIjANoO318CzLOsnG9DTgXaaSfQyzzcssp3E4o=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist9 Login ]\033[0m"""%(Bot_startTime))

k10 = LINE("EIqiCfDSjyI7gBLWpDZ2.FBq+xDmIg2CpbcRJjCvaqG.YqtBb62PkBraacdROPbrTIa6A9bP2m8od4dMVC4bwQ0=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist10 Login ]\033[0m"""%(Bot_startTime))

g1 = LINE("EILU71UfM91ZnTY2bbv1.TGKkP1RisfWc0UW4Z9NfOq.Nw28pDVLno0Mo/yeANNIhJqjBDg1F5ZN15jyc9obp/E=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Kicker1 Login ]\033[0m"""%(Bot_startTime))

g2 = LINE("EI81KoYVnjyyoH418xJe.typOv1wAnNQEuP4XmEqj3G.HWeTVmtCC1ZfOxr3Xad+LnkXozr+5ei5UMbW4NbXbdo=")
...
oepoll = OEPoll(cl)
call = cl
creator = ["u05ac5e80ee95c6a8b4beb1ce30b0779b"]
owner = ["u212b016db02b469b9d52d90889501b55","u3be50a0a5f9b5b3b97a0490d675c857d","u05ac5e80ee95c6a8b4beb1ce30b0779b",u6c69729c1a011e83329ada01f0b9d4ce"]
admin = ["u212b016db02b469b9d52d90889501b55","u3be50a0a5f9b5b3b97a0490d675c857d","u05ac5e80ee95c6a8b4beb1ce30b0779b",u6c69729c1a011e83329ada01f0b9d4ce"]
staff = ["u6c69729c1a011e83329ada01f0b9d4ce"]
#==============================================================================
...
def help():
    ...
    key = key.title()
    helpMessage = "╭━━━━━━━━━━━━━━━\n"
    helpMessage += "│┃ " + "╭──☠⁐[̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]✍⁐☠─\n"
    ...
    helpMessage += "│┃ " + "╰──⍟ ☠⁐[̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]✍⁐☠ ⍟─────────\n"
    helpMessage += "╰━━━━━━━━━━━━━━━━"
    helpMessage += " Creator: http://line.me/ti/p/~shahzain83 \n"
    return helpMessage
...
def helpbot():
    ...
    key = key.title()
    helpMessage2 = "╭━━━━━━━━━━━━━━━━\n"
    helpMessage2 += "│┃ " + "╭───⍟☠⁐[̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]✍⁐☠⍟─\n"
    ...
    helpMessage2 += "│┃ " + "╰──⍟ ☠⁐[̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]✍⁐☠ ⍟────────\n"
    helpMessage2 += "╰━━━━━━━━━━━━━━━━"
    helpMessage2 += " My ID LINE : 〘 http://line.me/ti/p/~shahzain83 〙\n"
    return helpMessage2
                        ...
                        if cmd == ".login":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                tz = pytz.timezone("Asia/Jakarta")
                                timeNow = datetime.now(tz=tz)
                                md = "│╔══[ ☠⁐[̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]✍⁐☠🔰 ] \n"
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                               try:
                                   ...
                                   cl.sendMessage(msg.to,"Chat already d clean up 👍")
                               except:
                                   pass
                          ...
                          if msg._from in owner or msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated = []
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "☠⁐[̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]✍⁐☠ ɪɴғᴏ\n"
                                ret_ += "\nName Group : {}".format(G.name)
                                ret_ += "\nID Group : {}".format(G.id)
...
#===========BOT UPDATE============#
                         ...
                         if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               k1.sendMessage(msg.to, "👑✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η👑")
                               k2.sendMessage(msg.to, "👑✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η👑")
                               k3.sendMessage(msg.to, "👑✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η👑")
                               k4.sendMessage(msg.to, "👑✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η👑")
                               k5.sendMessage(msg.to, "👑✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η👑")
                               k6.sendMessage(msg.to, "👑✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η👑")
                               k7.sendMessage(msg.to, "👑✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η👑")
                               k8.sendMessage(msg.to, "👑✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η👑")
                               k9.sendMessage(msg.to, "👑✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η👑")
                               k10.sendMessage(msg.to, "👑✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η👑")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.sendMessage(msg.to, "Makasih already invit\nketemu lain waktu... "+str(G.name))
...
#===========Protection============#
                        ...
                        elif '.power ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('.power ','')
                              if spl == 'on':
                                  if msg.to in protectqr:
                                       msgs = ""
                                  else:
